...
class MyGUI:
    ...
    def create_buttons(self):
        button_info = [
            {"label": "CNC1", "x": -0.9, "y": 0.85, "yaw": 1.570796},
            {"label": "CNC2", "x": 0, "y": 0.85, "yaw": 1.570796},
            {"label": "CNC3", "x": 0.9, "y": 0.85, "yaw": 1.570796},
            {"label": "CNC4", "x": -0.9, "y": -0.05, "yaw": 1.570796},
            {"label": "CNC5", "x": 0, "y": -0.05, "yaw": 1.570796},
            {"label": "CNC6", "x": 0.9, "y": -0.05, "yaw": 1.570796},
            {"label": "Initialize", "x": -0.9, "y": 0.85, "yaw": 1.570796}
        ]
